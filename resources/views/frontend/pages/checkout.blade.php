  ...
  <div class="card card-body container margin-top-20 mb-3">
	<div class="card card-body">
		...
		<div class="row">
			...
			@foreach (App\Models\Cart::totalCarts() as $cart)
			 ...
			 <p>Total Price with shipping cast: <strong>{{$total_price + App\Models\Setting::first()->shipping_cost}} </strong> Taka</p>
			</div>
		</div>
		<p>
	...
	<div class="card card-body mt-2">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <textarea id="message" class="form-control{{ $errors->has('message') ? ' is-invalid' : '' }}" rows="4" name="message">{{ Auth::check() ? Auth::user()->message : ''}}</textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
           <select name="payment_method_id" id="" class="form-control" required id="payments">
		     ...
		     @foreach ($payments as $payment)
              ...
              @else
			    ...
			    @endforeach
				 <input type="text" name="transaction_id" id="transaction_id" class="form-control " placeholder="Enter transaction code" required>
