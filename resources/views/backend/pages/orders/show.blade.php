    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('admin.order.charge', $order->id) }}" class="" method="post">
          @csrf
          <label for=""></label>
          <input type="hidden" name="shipping_charge" id="shipping_charge" value="{{ $order->shipping_charge }}">
          <br>

          <label for=""></label>

          <input type="hidden" name="custom_discount" id="custom_discount"  value="{{ $order->custom_discount }}">
          <br>

          <input type="hidden" value="Update" class="btn btn-success">
